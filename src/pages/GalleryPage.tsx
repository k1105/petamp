...
import { NamedPlaceMapLayers } from '../components/gallery/NamedPlaceMapLayers'
...
import { hasRenderedNamedPlaceAtPoint } from '../lib/mapbox/namedPlaces'
  ...
  const layers = useMemo(() => {
    ...
    const onTrailClick = (info: { object?: { id: string }; x?: number; y?: number }) => {
      ...
      if (map && info.x != null && info.y != null) {
        try {
          if (hasRenderedNamedPlaceAtPoint(map, [info.x, info.y])) return
        } catch {
